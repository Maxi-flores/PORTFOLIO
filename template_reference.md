# Portfolio Template Reference & Automation Governance

=== Current portfolio template reference:
...
Portfolio Template Core Purpose:
*   Keep a single source of truth for the active portfolio template version.
*   Support future automation flows and GitHub Copilot prompts that read template metadata.
*   Ensure the frontend UI dynamically highlights high-value prospecting skills, Meta Ads experience, and Cloud Data metrics based on the active theme.
